...
const pagesPath = 'src/containers'
...
module.exports = {
  ...
  prompts: [
    ...
    },
    {
      ...
      message: 'In which page do you wanna put this component',
    },
    {
      type: 'confirm',
      name: 'wantMessages',
  ...
  actions: data => {
    ...
    if (data.page === SHARED) {
      ...
      actions.push(
        {
          type: 'add',
          path: '../../src/components/{{page}}/{{properCase name}}/index.js',
          templateFile: './component/index.js.hbs',
          abortOnFail: true,
        },
        {
          type: 'add',
          path: '../../src/components/{{page}}/{{properCase name}}/{{properCase name}}.jsx',
          templateFile: './component/comoponents.jsx.hbs',
          abortOnFail: true,
        },
        {
          type: 'add',
          path: '../../src/components/{{page}}/{{properCase name}}/tests/index.test.js',
          templateFile: './component/test.js.hbs',
          abortOnFail: true,
        },
      )
      actions.push({
        type: 'add',
        path: '../../src/components/{{page}}/{{properCase name}}/{{dashCase name}}.scss',
        templateFile: './container/styles.scss.hbs',
        abortOnFail: true,
      });
      // If the user wants i18n messages
      if (data.wantMessages) {
        actions.push({
          type: 'add',
          path: '../../src/components/{{page}}/{{properCase name}}/messages.js',
          templateFile: './component/messages.js.hbs',
          abortOnFail: true,
        });
      }
      ...
      if (data.wantLoadable) {
        actions.push({
          type: 'add',
          path: '../../src/components/{{page}}/{{properCase name}}/Loadable.js',
          templateFile: './component/loadable.js.hbs',
          abortOnFail: true,
        });
      }
